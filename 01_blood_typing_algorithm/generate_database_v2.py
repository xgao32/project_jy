...
def main(hg38_exonFile, hg19_exonFile, hg38_genome, hg38_version, hg19_genome, hg19_version, databaseFile, outdir):
    ...
    #1
    databaseFile = inputdir + "db_oriInput/002_MNS_Typer_database_hg38-hg19_v2_jy.txt"
    print(databaseFile)
...
outdir = "/root/projects/projects_jy/WGS_blood/02_reference_database/db_genomeAnno/"

hg19_exonFile = inputdir + "MNS-RH_exon_position_hg19_jy.txt"
hg38_exonFile = inputdir + "MNS-RH_exon_position_hg38_jy.txt"

hg19_genome = "/root/projects/projects_jy/WGS_blood/04_blood_typing/input/Genome_refseq/GCF_000001405.25_GRCh37.p13_genomic.fna"
...
hg38_genome = "/root/projects/projects_jy/WGS_blood/04_blood_typing/input/Genome_refseq/GCF_000001405.39_GRCh38.p13_genomic.fna"
