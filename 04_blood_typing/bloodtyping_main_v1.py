...
parser = argparse.ArgumentParser(description="blood typing",
                                 prog="bloodtyping_main_v4.py",
                                 usage = "python bloodtyping_main_v4.py -i <input bam file> -o <output directory> -s <system> -g <genome version>")
...
if (vcf == None):
    ...
    vcf_args = {}
    vcf_args["pre-process_path"] = basedir + "/script/pre-process.py"
